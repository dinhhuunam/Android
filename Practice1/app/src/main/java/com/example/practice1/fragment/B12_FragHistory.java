...
public class B12_FragHistory extends Fragment implements B12_RecycleViewAdapter.ItemListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.b12_frag_history,container,false);
    }
